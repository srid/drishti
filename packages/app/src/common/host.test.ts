...
import { ADMIN_HOST_SENTINEL, isValidHost } from "./host";
...
describe("isValidHost", () => {
  ...
  it("rejects empty, whitespace-bearing, and sentinel hosts", () => {
    ...
    // The control-plane sentinel is ssh-safe but reserved for routing, so
    // it must not be admissible as a real host.
